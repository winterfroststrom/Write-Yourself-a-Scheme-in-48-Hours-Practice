...
(define (mem-helper2 obj lst op op2)
  (fold mem-helper (curry op obj) op2) #f lst)

(define (memq obj lst)
  (mem-helper2 obj lst eq? id))

(define (memv obj lst)
  (mem-helper2 obj lst eqv? id))

(define (member obj lst)
  (mem-helper2 obj lst equal? id))

(define (assq obj alist)
  (mem-helper2 obj lst eq? car))

(define (assv obj alist)
  (mem-helper2 obj lst eqv? car))

(define (assoc obj alist)
  (mem-helper2 obj lst equal? car))
